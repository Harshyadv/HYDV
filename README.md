...
Inspired by Jake Ginesin’s [site](https://github.com/JakeGinesin/jakegines.in), recreated from scratch with a reduced footprint and a black-and-white aesthetic.

The Favicon and the Background (Python created GIF) are the original creation.
